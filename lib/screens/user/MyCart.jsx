...
import { View, Text, StyleSheet, TouchableOpacity, Image, ScrollView, TouchableHighlight, Alert } from 'react-native';
...
const MyCart = ({ navigation }) => {
    ...
    const fetchCartItems = async () => {
        try {
            const deliveryAddressSnapshot = await firestore().collection('users').doc(userId).get();
            if (deliveryAddressSnapshot.data().address == null || deliveryAddressSnapshot.data().address == ''){
                Alert.alert('No address found');
                setError(true);
            }
            else{
            setDeliveryAddress(deliveryAddressSnapshot.data().address);
        }
